...
class Project(QTabWidget):
    def __init__(self,p = None):
        ...
        self.insert_info.setStyleSheet("background-color: rgb(245,222,179);")
        self.update_info = QWidget()
        self.update_info.setStyleSheet("background-color: rgb(245,222,179);")
        self.delete_info = QWidget()
        self.delete_info.setStyleSheet("background-color: rgb(245,222,179);")
        self.find_info  =  QWidget()
        self.find_info.setStyleSheet("background-color: rgb(245,222,179);")
    ...
    def show_info(self,sql = "SELECT * from maktab"):
        ...
        self.tablo_1.setFont(QFont("Calibri",24))
        self.tablo_1.setStyleSheet("color: magenta")
        self.tablo_1.setRowCount(14)
        self.tablo_1.setColumnCount(5)
        self.tablo_1.setHorizontalHeaderLabels(["id","Nomi","O'quvchilar Soni","Ishchilar Soni","Address"])
        header = self.tablo_1.horizontalHeader()
        header.setFont(QFont("Calibri",24))
        for x in range(5):
    ...
    def update_data(self):
        ...
        self.select_cmb.addItems(["id","Nomi","O'quvchilar Soni","Ishchilar Soni","Address"])
        ...
        self.select_cmb1.addItems(["id","Nomi","O'quvchilar Soni","Ishchilar Soni","Address"])
    ...
    def edit_info(self):
        ls = ["id","Nomi","O'quvchilar Soni","Ishchilar Soni","Address"]
        self.con = myc.connect(host = 'localhost',user = 'root',password = 'Najot1995!',database = 'maktab')
        self.kur = self.con.cursor()
    ...
    def delete_data(self):
        ...
        self.delete_cmb.addItems(["id","Nomi","O'quvchilar Soni","Ishchilar Soni","Address"])
    ...
    def find_data(self):
        ...
        self.find_cmb.addItems(["id","Nomi","O'quvchilar Soni","Ishchilar Soni","Address"])
